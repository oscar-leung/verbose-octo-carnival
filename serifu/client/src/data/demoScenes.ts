...
/** Nighttime camp: Frieren lectures on stars and magic while Fern and Stark fight off sleep. */
export const SCENE_STARRY_LESSON: SkitScript = {
  title: '葬送のフリーレン — 星空の授業 (デモ)',
  characters: [
    { id: 'frieren', name: 'フリーレン', color: '#7ecbff' },
    { id: 'fern', name: 'フェルン', color: '#f5c2e7' },
    { id: 'stark', name: 'シュタルク', color: '#f38ba8' },
  ...
  lines: [
    {
      ...
      translation: 'The stars are beautiful tonight — shall we talk about magic while we watch them?',
      vocab: [
        { w: '今夜', r: 'こんや', en: 'tonight' },
        { w: '星', r: 'ほし', en: 'star' },
      ],
      grammar: [
        { p: '〜ながら', en: '"while ~ing" — one person doing two actions at once: 見ながら話す = talk while watching' },
        { p: '〜ようか', en: 'volitional + か: a soft proposal, "shall we ~?"' },
      ],
    },
    {
      id: 'sk-2',
      ...
      translation: "Sorry, but I'm already sleepy. My whole body's worn out today.",
      vocab: [
        { w: '眠い', r: 'ねむい', en: 'sleepy' },
        { w: 'だるい', en: 'sluggish, heavy, worn out' },
      ],
      grammar: [
        { p: '悪いけど', en: 'casual apology opener: "sorry, but…"' },
        { p: '〜って', en: 'emphatic quoting ending: "I\'m telling you, ~"' },
      ],
    },
    {
      id: 'sk-3',
      ...
      translation: 'Me too — a moment ago I almost fell asleep standing up.',
      vocab: [
        { w: '先ほど', r: 'さきほど', en: 'a little while ago (polite)' },
      ],
      grammar: [
        { p: '〜そうになる', en: '"almost happened" — came right to the verge of ~: 眠りそうになった = almost fell asleep' },
        { p: '〜たまま', en: 'in an unchanged state: 立ったまま = while still standing' },
      ],
    },
    {
      id: 'sk-4',
      ...
      translation: "I've actually seen the color of a star change before.",
      vocab: [{ w: '色', r: 'いろ', en: 'color' }],
      grammar: [
        { p: '〜たことがある', en: '"have the experience of ~ing" — past tense + ことがある' },
        { p: '〜のを見る', en: '"see (something) happen" — の turns the whole event into a noun' },
      ],
    },
    {
      id: 'sk-5',
      ...
      translation: 'If you live that long, you even get to see stuff like that?',
      vocab: [
        { w: '生きる', r: 'いきる', en: 'to live, to be alive' },
        { w: '長い', r: 'ながい', en: 'long' },
      ],
      grammar: [
        { p: '〜と', en: 'natural-consequence conditional: "if/whenever ~, then inevitably…"' },
        { p: '〜まで', en: '"even ~" — going further than expected: そんなものまで = even things like that' },
      ],
    },
    {
      id: 'sk-6',
      ...
      translation: 'There should be lots of shooting stars tonight, too. The sky is so clear, after all.',
      vocab: [
        { w: '流れ星', r: 'ながれぼし', en: 'shooting star' },
        { w: '澄む', r: 'すむ', en: 'to be clear (air, water, sky)' },
      ],
      grammar: [
        { p: '〜はず', en: '"should / is bound to" — a confident expectation based on reasons' },
      ],
    },
    {
      id: 'sk-7',
      ...
      translation: "Fern, I've noticed your eyes are half closing, you know.",
      vocab: [
        { w: '気づく', r: 'きづく', en: 'to notice, to realize' },
        { w: '閉じる', r: 'とじる', en: 'to close (eyes, a book)' },
      ],
      grammar: [
        { p: '〜のに気づく', en: '"notice that ~" — の nominalizes the clause before 気づく' },
        { p: '〜かける', en: '"on the verge of / halfway into ~ing": 閉じかける = starting to close' },
      ],
    },
    {
      id: 'sk-8',
      ...
      translation: "I'm so sorry. I wasn't supposed to be sleepy, but…",
      vocab: [
        { w: '申し訳ありません', r: 'もうしわけありません', en: 'formal apology — "I have no excuse"' },
      ],
      grammar: [
        { p: '〜はずだった', en: '"was supposed to ~" — the expectation did not hold' },
        { p: '〜のですが…', en: 'polite trailing "but…" — leaving the excuse unfinished' },
      ],
    },
    {
      id: 'sk-9',
      ...
      translation: "I wasn't sleeping! I was just listening with my eyes closed.",
      vocab: [{ w: '寝る', r: 'ねる', en: 'to sleep, to go to bed' }],
      grammar: [
        { p: '〜てねえ', en: 'rough masculine contraction of 〜ていない: "am not ~ing"' },
        { p: '〜ぞ', en: 'masculine emphatic ending — asserting firmly' },
      ],
    },
    {
      id: 'sk-10',
      ...
      translation: "Heh — you don't have to push yourselves. We'll pick this up tomorrow, watching the stars again.",
      vocab: [
        { w: '無理する', r: 'むりする', en: 'to push oneself too hard' },
        { w: '続き', r: 'つづき', en: 'continuation, the rest' },
      ],
      grammar: [
        { p: '〜なくていい', en: '"don\'t have to ~" — permission not to do something' },
      ],
    },
  ],
};

/** A quiet crossroads: Frieren, Himmel, and Heiter part ways, promising to meet down the road. */
export const SCENE_CROSSROADS: SkitScript = {
  title: '葬送のフリーレン — 別れ道 (デモ)',
  characters: [
    { id: 'frieren', name: 'フリーレン', color: '#7ecbff' },
    { id: 'himmel', name: 'ヒンメル', color: '#b4befe' },
    { id: 'heiter', name: 'ハイター', color: '#a6e3a1' },
  ...
  lines: [
    {
      ...
      tokens: [
        { t: 'ここでお' },
        { t: '別', r: 'わか' },
        { t: 'れだね。フリーレンはこれからどうするつもり？' },
      ],
      translation: 'This is where we part. What do you plan to do from here, Frieren?',
      vocab: [
        { w: 'お別れ', r: 'おわかれ', en: 'parting, farewell' },
        { w: 'これから', en: 'from now on, from here' },
      ],
      grammar: [
        { p: '〜つもり', en: '"intend / plan to ~" — asking about someone\'s intention' },
      ],
    },
    {
      id: 'wk-2',
      ...
      translation: "I'm planning to go see the ruins in the north. There might be a rare spell there.",
      vocab: [
        { w: '遺跡', r: 'いせき', en: 'ruins' },
        { w: '珍しい', r: 'めずらしい', en: 'rare, unusual' },
      ],
      grammar: [
        { p: '〜かもしれない', en: '"might ~ / maybe" — a real possibility, not a certainty' },
        { p: 'ます-stem＋に行く', en: 'purpose of movement: 見に行く = go (in order) to see' },
      ],
    },
    {
      id: 'wk-3',
      ...
      translation: "I'll walk as far as the next village. There's a church there, you see.",
      vocab: [
        { w: '教会', r: 'きょうかい', en: 'church' },
        { w: '次', r: 'つぎ', en: 'next' },
      ],
      grammar: [
        { p: '〜まで', en: '"until / as far as ~" — the endpoint a continuous action lasts to' },
      ],
    },
    {
      id: 'wk-4',
      ...
      translation: "Then let's meet in the bridge town before winter comes. It's a promise.",
      vocab: [
        { w: '冬', r: 'ふゆ', en: 'winter' },
        { w: '橋', r: 'はし', en: 'bridge' },
      ],
      grammar: [
        { p: '〜までに', en: '"by (a deadline)" — the action happens once before that point; contrast まで, which marks continuing all the way until it' },
      ],
    },
    {
      id: 'wk-5',
      ...
      translation: "By that day, I'll have learned one new spell, ready to show you.",
      vocab: [
        { w: '覚える', r: 'おぼえる', en: 'to learn, to memorize' },
        { w: '新しい', r: 'あたらしい', en: 'new' },
      ],
      grammar: [
        { p: '〜ておく', en: '"do ~ in advance" — preparation so it\'s ready for later: 覚えておく = learn it ahead of time' },
      ],
    },
    {
      id: 'wk-6',
      ...
      translation: 'I hear the road ahead is rough, so please be careful.',
      vocab: [
        { w: '気をつける', r: 'きをつける', en: 'to be careful, to take care' },
        { w: 'この先', r: 'このさき', en: 'up ahead, further along' },
      ],
      grammar: [
        { p: 'plain form＋そうだ', en: 'hearsay: "I hear that ~" — different from the looks-like そう built on the stem' },
        { p: '気をつけて', en: 'set farewell phrase: "take care / be safe"' },
      ],
    },
    {
      id: 'wk-7',
      ...
      translation: "Don't look so sad. We'll be able to meet again, after all.",
      vocab: [
        { w: '寂しい', r: 'さびしい', en: 'lonely; sad to part' },
        { w: '僕たち', r: 'ぼくたち', en: 'we — gentle masculine' },
      ],
      grammar: [
        { p: '〜ないで', en: 'gentle request not to do something: "please don\'t ~"' },
        { p: '〜がる', en: 'showing outward signs of a feeling: 寂しがる = act/look lonely' },
      ],
    },
    {
      id: 'wk-8',
      ...
      translation: "It's not like I'm lonely or anything. …Probably.",
      vocab: [{ w: 'たぶん', en: 'probably' }],
      grammar: [
        { p: '〜なんかない', en: 'dismissive denial: "not ~ or anything" — brushing a feeling off' },
      ],
    },
    {
      id: 'wk-9',
      ...
      translation: 'Well then — see you in the bridge town. And Heiter, go easy on the drink.',
      vocab: [
        { w: 'お酒', r: 'おさけ', en: 'alcohol, drink' },
        { w: 'ほどほどに', en: 'in moderation' },
      ],
      grammar: [
        { p: 'じゃあまた', en: 'standard casual farewell: "see you" — the meeting place attaches with で' },
        { p: '〜はほどほどに', en: 'set phrase: "keep ~ in moderation" — the verb is left unsaid' },
      ],
    },
    {
      id: 'wk-10',
      ...
      translation: 'I shall see what I can do. Well then, everyone — stay well.',
      vocab: [
        { w: '善処する', r: 'ぜんしょする', en: '"I\'ll see what I can do" — a politely evasive promise' },
        { w: '皆さん', r: 'みなさん', en: 'everyone' },
      ],
      grammar: [
        { p: 'お元気で', en: 'farewell wishing good health — used when parting for a while' },
        { p: 'それでは', en: 'formal "well then" — signaling the close of a conversation' },
      ],
    },
  ],
};
...
export const PUBLIC_SCENES: { slug: string; script: SkitScript }[] = [
  ...
  { slug: 'starry-lesson', script: SCENE_STARRY_LESSON },
  { slug: 'crossroads', script: SCENE_CROSSROADS },
